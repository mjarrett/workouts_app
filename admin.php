<?php require 'check_super_cookie.php'; ?>
...
<?php
   ...
   $result = mysql_query("SELECT exercises.exercise, sets, reps, weight, difficulty, time, distance, effort, date, user_id
   ...
   echo "<table border=1>";
   echo "<tr> <th>User</th><th>Date</th><th>Exercise</th> <th>weight</th> <th>reps</th><th>sets</th><th>difficulty</th><th>time</th><th>distance</th><th>effort</th>  <th><input type='submit' value='See More'></th></tr>";
